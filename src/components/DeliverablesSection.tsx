      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div dir="rtl">
          ...
          <div className="grid gap-2 md:gap-4">
            {rows.map((r, i) => (
              <div key={i} className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                {/* RIGHT cell: included (first in DOM for RTL) */}
                <div className="bg-white min-h-[60px] md:min-h-[72px] p-4 md:p-5 flex items-center">
                  {r.included ? (
                ...
                <div className="bg-white/50 min-h-[60px] md:min-h-[72px] p-4 md:p-5 flex items-center">
                  {r.excluded ? (
                    <div className="flex items-center gap-3 w-full">
