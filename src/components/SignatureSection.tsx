              ...
              <ScrollAnimation delay={0.1}>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary rounded-full px-5 md:px-6 py-3 md:py-4 text-right text-foreground outline-none focus:ring-2 focus:ring-primary/50 transition-shadow"
                  />
                </div>
              </ScrollAnimation>
