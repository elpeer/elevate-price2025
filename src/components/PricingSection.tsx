        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="md:order-2">
            ...
            <ScrollAnimation delay={0.2}>
              <motion.div 
                layout
                className="rounded-[24px] md:rounded-[32px] px-3 md:px-4 pb-3 md:pb-4" 
              ...
              >
                ...
                <motion.div 
                  layout
                  className="bg-white rounded-[48px] md:rounded-[68px] px-4 md:px-6 py-2 md:py-3 flex items-center justify-between"
                >
